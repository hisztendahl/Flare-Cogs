...
from .utils import mapcountrytoflag, mergeDict, getformbonus, getformbonuspercent
...
class NatStatsMixin(MixinMeta):
    ...
    @nat_stats.command(name="recap")
    async def nat_recap(self, ctx, user: discord.Member = None):
        """Sim League Statistics."""
        if user is not None:
            stats = await self.config.guild(ctx.guild).nstats()
            notes = await self.config.guild(ctx.guild).natnotes()
            userid = str(user.id)
    ...
    @checks.admin_or_permissions(manage_guild=True)
    @nat_stats.command(name="addnotes")
    ...
    @checks.admin_or_permissions(manage_guild=True)
    @nat_stats.command(name="removenote")
    ...
    @checks.admin_or_permissions(manage_guild=True)
    @nat_stats.command(name="clearnotes")
    ...
    @nat_stats.command(name="viewnotes")
    ...
    @checks.admin_or_permissions(manage_guild=True)
    @nat_stats.command(name="addteamstats")
    ...
    @checks.admin_or_permissions(manage_guild=True)
    @nat_stats.command(name="addstats")
    ...
    # @nat_stats.command(name="teamstats")
    ...
    @nat_stats.command(name="notes")
    async def nat_notes(self, ctx):
    ...
    @nat_stats.command(name="ga", alias=["ga", "contributions"])
    async def nat_goals_assists(self, ctx):
    ...
    @nat_stats.command(name="goals", alias=["topscorer", "topscorers"])
    async def nat_goals(self, ctx):
    ...
    @nat_stats.command(name="owngoals")
    async def nat_owngoals(self, ctx):
    ...
    @nat_stats.command(name="yellows", aliases=["yellowcards"])
    ...
    @nat_stats.command(name="reds", alies=["redcards"])
    ...
    @nat_stats.command(name="motm", alias=["motms"])
    ...
    @nat_stats.command(name="fouls", alias=["fouls"])
    ...
    @nat_stats.command(name="shots", alias=["shots"])
    ...
    @nat_stats.command(name="penalties")
    ...
    @nat_stats.command(name="assists")
